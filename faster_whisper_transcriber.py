...
class FasterWhisperTranscriber:
    def __init__(self, root):
        self.root = root
        self.root.title("YouTube Transcriber - Faster Whisper")
    ...
    def setup_ui(self):
        ...
        self.progress.grid(row=8, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(10, 5))
        
        # Status
        self.status_var = tk.StringVar(value="Ready")
        ttk.Label(main_frame, textvariable=self.status_var).grid(row=9, column=0, sticky=tk.W, pady=(0, 10))
        
        # Log
        ttk.Label(main_frame, text="Output Log:").grid(row=10, column=0, sticky=tk.W, pady=(0, 5))
    ...
    def transcribe_video(self):
        try:
            ...
            # Use the extracted STT utilities
...
def main():
    root = tk.Tk()
    app = FasterWhisperTranscriber(root)
    root.mainloop()
